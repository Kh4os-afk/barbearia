                ...
                <form action="#" method="post" role="form" class="pp" data-aos="fade-up" data-aos-delay="100">
                    <center>
                            <div class="col-lg-4 form-group">
                                <input type="text" autocomplete="off" name="nome" class="form-control" require="" placeholder="Login" data-rule="minlen:4" >
                                <p></p>
                                <input type="password" autocomplete="off" class="form-control" require="" name="telefone" placeholder="senha" data-rule="minlen:4" >
                            </div>
